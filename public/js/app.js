...
function showdivmods() {
  var div = document.getElementById("div_mods");
...
function openconfirmcreate() {
  var modal = document.getElementById("confirmcreate");
  if (modal.style.display === "none") {
...
function carregarTabela() {
  $(document).ready(function () {
    $("btn-pericias").click(function () {
      ...
      $(function () {
        $("pericias").load("table_pericias.php");
      });
    })
  });
}
...
function calcularResistencia() {
  ...
  var baseref = document.getElementById('baseref').value;
  var habref = document.getElementById('habref').value;
  var magicref = document.getElementById('magicref').value;
  var otherref = document.getElementById('otherref').value;
  ...
  var otherwill = document.getElementById('otherwill').value;


  var totalfor = parseInt(basefor) + parseInt(habfor) + parseInt(magicfor) + parseInt(otherfor);
  var totalref = parseInt(baseref) + parseInt(habref) + parseInt(magicref) + parseInt(otherref);
  var totalwill = parseInt(basewill) + parseInt(habwill) + parseInt(magicwill) + parseInt(otherwill);



  document.getElementById('for').value = totalfor;
...
function dropdownhead() {
  var btndrop = document.getElementById('btn_dropdown');
  var divdrop = document.getElementById('divdropdown');
