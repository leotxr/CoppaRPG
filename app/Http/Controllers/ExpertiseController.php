...
class ExpertiseController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('expertises', compact('expertise'));
    }
    ...
    public function update_exp(Request $request)
    {
        ...
        $expertises = DB::table('expertises')
            ->where('id', $request->input('expertise_id'))
            ->update(
                [
        ...
        /*
        $expertises = Expertise::where(['id' => $request->input('expertise_id')])->update([
            //bd                html
    ...
    public function infomyexpertises(Request $request)
    {

        $char_id = $request->input('char_id');
        $sql = "Select * from expertises ";
        $sql = $sql . " WHERE char_id = '$char_id'  ";
        $expertises = DB::select($sql);
        return view('expertises', ['expertises' => $expertises]);
    }

    public function infoexpertisestable()
    {
        $expertises = Expertise::all();
        return view('expertises', compact('expertises', $expertises));
    }
}
